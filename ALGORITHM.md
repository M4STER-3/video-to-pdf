...
2. **Calibration bornée.** Six paires rapprochées, à 192 px, fournissent une estimation du bruit visuel. Un quantile bas détermine un seuil, borné pour éviter qu’une vidéo entièrement en mouvement ne soit prise comme référence de stabilité. Le réglage utilisateur multiplie cette référence.
...
6. **Extraction originale.** Chaque candidate conservée est relue au timestamp choisi et capturée aux dimensions originales du recadrage. Les captures confirmées comme doublons ne sont pas encodées en haute résolution. Le PDF conserve ces dimensions et le ratio, quelle que soit l’orientation.
